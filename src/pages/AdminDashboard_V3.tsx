        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-6">
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white shadow-lg">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                <p className="text-sm opacity-90 mb-1">전체 플레이스</p>
                <p className="text-4xl font-bold">{adminStats.static.totalPlaces.toLocaleString()}</p>
              </div>
            </div>
            <p className="text-sm opacity-90">등록된 장소</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6 text-white shadow-lg">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                <p className="text-sm opacity-90 mb-1">총 리뷰</p>
                <p className="text-4xl font-bold">{adminStats.static.totalReviews.toLocaleString()}</p>
              </div>
            </div>
            <p className="text-sm opacity-90">영수증 리뷰</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-6 text-white shadow-lg">
            <div className="flex items-center justify-between mb-4">
              <FileText className="w-12 h-12 opacity-80" />
              <div className="text-right">
                <p className="text-sm opacity-90 mb-1">총 블로그</p>
                <p className="text-4xl font-bold">{adminStats.static.totalBlogs.toLocaleString()}</p>
              </div>
            </div>
            <p className="text-sm opacity-90">{adminStats.static.totalBlogs === 0 ? '미구현' : '블로그'}</p>
          </div>

          <div className="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl p-6 text-white shadow-lg">
            <div className="flex items-center justify-between mb-4">
              <LinkIcon className="w-12 h-12 opacity-80" />
              <div className="text-right">
                <p className="text-sm opacity-90 mb-1">총 트래픽</p>
                <p className="text-4xl font-bold">{adminStats.static.totalTraffic.toLocaleString()}</p>
              </div>
            </div>
            <p className="text-sm opacity-90">{adminStats.static.totalTraffic === 0 ? '미구현' : '트래픽'}</p>
          </div>
        </div>
